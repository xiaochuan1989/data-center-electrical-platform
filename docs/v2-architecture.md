...
8. 铜排工程计算器 Excel 示例（120×10mm、外部环境35℃、工程控制温升70K、自动最高温度105℃、柜内空气温升15K、有效散热温差55K、h=5、ε=0.35）应得到热平衡电流 2512.862393A，80%建议值 2010.289914A；同时保证 A03 按电流选型结果不变。
